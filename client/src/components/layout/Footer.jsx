    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/vendors" className="hover:text-primary-400">
                  {t('nav.vendors')}
                </Link>
              </li>
              <li>
                <Link to="/become-vendor" className="hover:text-primary-400">
                  Become a Vendor
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/returns-refunds" className="hover:text-primary-400">
                  Returns & Refunds
                </Link>
              </li>
              <li>
            ...
            <form className="flex">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:border-primary-500 text-white"
                />
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">
            &copy; {currentYear} MarketPlace. {t('footer.copyright')}
          </p>
